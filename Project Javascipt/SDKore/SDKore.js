...
SDKore = {
    ...
    OData: new function () {
        ...
        */
        ...
        this.limparParamteros = function () {
            /// <summary>
            /// Realiza a limpeza dos parametros configurados para Retrieve ou RetrieveMutiple
            /// </summary>
            this.stringParametros = "";
        }
    ...
    RetrieveOptionSetLabel: function (entity, optionSetAttributeName, optionValue) {
        ...
        //var AssignAttributeName = optionSetAttributeName;
